...
import owl from 'public/images/logo/owl.png'
        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                      href="https://www.instagram.com/owl_eip?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#000000"
                         height="50px" width="50px" version="1.1" id="Layer_1" viewBox="0 0 455.73 455.73">
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              {" Projet d'étude EIP 2024 - Epitech Paris"}
            </p>
          </div>
        </div>
